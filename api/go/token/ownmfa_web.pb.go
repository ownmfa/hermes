...
var file_token_ownmfa_web_proto_rawDesc = []byte{
	...
	0x6f, 0x66, 0x42, 0x27, 0x5a, 0x25, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
	0x2f, 0x6f, 0x77, 0x6e, 0x6d, 0x66, 0x61, 0x2f, 0x68, 0x65, 0x72, 0x6d, 0x65, 0x73, 0x2f, 0x61,
	0x70, 0x69, 0x2f, 0x67, 0x6f, 0x2f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}

var (
	file_token_ownmfa_web_proto_rawDescOnce sync.Once
	file_token_ownmfa_web_proto_rawDescData = file_token_ownmfa_web_proto_rawDesc
)

func file_token_ownmfa_web_proto_rawDescGZIP() []byte {
	file_token_ownmfa_web_proto_rawDescOnce.Do(func() {
		file_token_ownmfa_web_proto_rawDescData = protoimpl.X.CompressGZIP(file_token_ownmfa_web_proto_rawDescData)
	})
	return file_token_ownmfa_web_proto_rawDescData
}

var file_token_ownmfa_web_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_token_ownmfa_web_proto_goTypes = []interface{}{
...
func file_token_ownmfa_web_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_token_ownmfa_web_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Web); i {
			case 0:
				return &v.state
			case 1:
	...
	file_token_ownmfa_web_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*Web_UserId)(nil),
		(*Web_KeyId)(nil),
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_token_ownmfa_web_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_token_ownmfa_web_proto_rawDesc = nil
