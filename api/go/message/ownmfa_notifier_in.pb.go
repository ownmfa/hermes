...
var file_message_ownmfa_notifier_in_proto_rawDesc = []byte{
	...
	0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x74, 0x72, 0x61, 0x63, 0x65, 0x49, 0x64, 0x42, 0x29,
	0x5a, 0x27, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6f, 0x77, 0x6e,
	0x6d, 0x66, 0x61, 0x2f, 0x68, 0x65, 0x72, 0x6d, 0x65, 0x73, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x67,
...
var (
	...
	file_message_ownmfa_notifier_in_proto_rawDescData = file_message_ownmfa_notifier_in_proto_rawDesc
)

func file_message_ownmfa_notifier_in_proto_rawDescGZIP() []byte {
	file_message_ownmfa_notifier_in_proto_rawDescOnce.Do(func() {
		file_message_ownmfa_notifier_in_proto_rawDescData = protoimpl.X.CompressGZIP(file_message_ownmfa_notifier_in_proto_rawDescData)
	})
...
var file_message_ownmfa_notifier_in_proto_goTypes = []interface{}{
...
func file_message_ownmfa_notifier_in_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_message_ownmfa_notifier_in_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_message_ownmfa_notifier_in_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_message_ownmfa_notifier_in_proto_rawDesc = nil
