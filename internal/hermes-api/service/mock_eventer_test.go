...
func (mr *MockEventerMockRecorder) Latest(ctx, orgID, appID, identityID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEventerMockRecorder) List(ctx, orgID, identityID, end, start any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
