...
TEST_PG_URI = postgres://postgres:postgres@127.0.0.1/hermes_test
endif
...
# staticcheck defaults are all,-ST1000,-ST1003,-ST1016,-ST1020,-ST1021,-ST1022
	...
	golangci-lint run -E durationcheck,errname,exportloopref,forcetypeassert \
	-E goconst,godot,goerr113,gofumpt,gosec,nlreturn,prealloc,unconvert \
	-E unparam --exclude-use-default=false
...
init_db:
	...
	migrate -path config/db/hermes -database $(TEST_PG_URI)?sslmode=disable up
