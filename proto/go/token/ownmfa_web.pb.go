...
const file_token_ownmfa_web_proto_rawDesc = "" +
	"\n" +
	"\x16token/ownmfa_web.proto\x12\x10ownmfa.int.token\x1a\x15api/ownmfa_role.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xbd\x01\n" +
	"\x03Web\x12\x19\n" +
	...
	"\x04role\x18\x04 \x01(\x0e2\x10.ownmfa.api.RoleR\x04role\x129\n" +
	"\n" +
	"expires_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\texpiresAtB\n" +
	"\n" +
	"\bid_oneofB)Z'github.com/ownmfa/hermes/proto/go/tokenb\x06proto3"
